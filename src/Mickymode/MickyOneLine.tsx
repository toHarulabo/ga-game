import Color1 from "../MickyColor/Color1";
import Color2 from "../MickyColor/Color2";
import Color3 from "../MickyColor/Color3";
import Color4 from "../MickyColor/Color4";
...
export default function MickyOneLine(props: Props) {
