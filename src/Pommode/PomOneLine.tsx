import Color1 from "../PomColor/Color1";
import Color2 from "../PomColor/Color2";
import Color3 from "../PomColor/Color3";
import Color4 from "../PomColor/Color4";
...
export default function PomOneLine(props: Props) {
