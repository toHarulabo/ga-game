import Color1 from "../MarioColor/Color1";
import Color2 from "../MarioColor/Color2";
import Color3 from "../MarioColor/Color3";
import Color4 from "../MarioColor/Color4";
import Color5 from "../MarioColor/Color5";
...
export default function MarioOneLine(props: Props) {
