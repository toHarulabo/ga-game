...
import DoraOneLine from "./MarioOneLine";
import MarioOneLine from "./MarioOneLine";

export const Makemario = () => {
  ...
  useEffect(() => {
    async function initializeData() {
      const colorlist = [70, 22, 120, 29]; // red,black,hada,brownのマス数
