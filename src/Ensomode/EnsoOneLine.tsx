import Color1 from "../EnsoColor/Color1";
import Color2 from "../EnsoColor/Color2";
import Color3 from "../EnsoColor/Color3";
import Color4 from "../EnsoColor/Color4";
import Color5 from "../EnsoColor/Color5";
...
export default function EnsoOneLine(props: Props) {
