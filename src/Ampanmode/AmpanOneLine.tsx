import Color1 from "../AmpanColor/Color1";
import Color2 from "../AmpanColor/Color2";
import Color3 from "../AmpanColor/Color3";
import Color4 from "../AmpanColor/Color4";
import Color5 from "../AmpanColor/Color5";
...
export default function AmpanOneLine(props: Props) {
