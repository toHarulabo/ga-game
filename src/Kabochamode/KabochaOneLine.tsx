import Color1 from "../KabochaColor/Color1";
import Color2 from "../KabochaColor/Color2";
import Color3 from "../KabochaColor/Color3";
import Color4 from "../KabochaColor/Color4";
...
export default function KabochaOneLine(props: Props) {
