import Color1 from "../HariColor/Color1";
import Color2 from "../HariColor/Color2";
import Color3 from "../HariColor/Color3";
import Color4 from "../HariColor/Color4";
...
export default function HariOneLine(props: Props) {
