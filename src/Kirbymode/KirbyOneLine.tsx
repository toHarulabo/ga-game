import Color1 from "../KirbyColor/Color1";
import Color2 from "../KirbyColor/Color2";
import Color3 from "../KirbyColor/Color3";
import Color4 from "../KirbyColor/Color4";
...
export default function KirbyOneLine(props: Props) {
