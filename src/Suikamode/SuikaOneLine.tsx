import Color1 from "../SuikaColor/Color1";
import Color2 from "../SuikaColor/Color2";
import Color3 from "../SuikaColor/Color3";
import Color4 from "../SuikaColor/Color4";
import Color5 from "../SuikaColor/Color5";
...
export default function SuikaOneLine(props: Props) {
