import Color1 from "../DoraColor/Color1";
import Color2 from "../DoraColor/Color2";
import Color3 from "../DoraColor/Color3";
import Color4 from "../DoraColor/Color4";
import Color5 from "../DoraColor/Color5";
...
export default function DoraOneLine(props: Props) {
